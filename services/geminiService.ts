...
const getClient = async () => {
  ...
  if (window.aistudio && await window.aistudio.hasSelectedApiKey()) {
      ...
      // But for robust code in this specific environment, we rely on the process.env.API_KEY being updated or available.
      // However, the prompt says "The selected API key is available via process.env.API_KEY".
      // So we just instantiate new GoogleGenAI.
  }
